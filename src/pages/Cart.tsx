...
export default function CartPage() {
    ...
    return (
        <div className="bg-slate-50 pb-20">
            <div className="max-w-[1400px] mx-auto p-2 md:p-6 rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                    ...
                    <div className="md:col-span-8 space-y-4">
                        {cart.map((item) => (
                            <div
                                key={item.id}
                                className="flex flex-col md:flex-row items-center md:items-start gap-4 p-4 rounded-2xl shadow-sm border border-slate-100 bg-white">
                                {/* Image */}
                                <img
                                    src={item.image}
                                    alt={item.name}
                    ...
                    {/* Summary */}
                    <div className="md:col-span-4 p-4 h-fit rounded-2xl shadow-sm border border-slate-100 bg-white">
